...
internal fun messageSpec(code: String): MessageSpec? = when (code) {
    ...
    "KEYTERM_SET_SAVED" -> MessageSpec.Text(R.string.keyterm_set_saved)
    "KEYTERM_SET_REFUSED" -> MessageSpec.Text(R.string.keyterm_set_refused)
    "NO_FOLDER_APP" -> MessageSpec.Text(R.string.no_folder_app)
